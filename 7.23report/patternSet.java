...
//			inter_p = inter_p.substring(next_pos + one_sentence.length());
	...
	public String replacebyrealofabs(String inputs) {
	...
	public String applyTo(String oldc) {
		...
		for (int i=0;i<pattern_o.size(); i++) {
			...
			String one_real_sentence = replacebyrealofabs(one_pattern_sentence);
...
//			inter_p = checkwithabs(inter_p, one_sentence);
			...
			String new_real_sentence = replacebyrealofabs(new_pattern_sentence);
