...
public class CommitComparatorClient {
	...
	public CommitComparatorClient(String projName, String lName) {
		...
		comparator.setLibDirForMigration("/home/shengzhex/Documents/research_repo/luna_api_migration/" + lName + "/");
		comparator.setResultDir("/home/shengzhex/Documents/research_repo/luna_api_migration/grapa_results/");
